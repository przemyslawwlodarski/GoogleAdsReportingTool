...
public class AuthenticateInStandaloneApplication {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (console == null) {
            ...
            clientId = "192553552323-udv56rbj282p1qs311pfasuq1i3t9b1f.apps.googleusercontent.com";
            clientSecret = "rlz1T-qpA6D0eNOvUdSQqoJ9";
    ...
    public void runExample(String clientId, String clientSecret) throws IOException {
        ...
        adsProperties.put(
                ConfigPropertyKey.DEVELOPER_TOKEN.getPropertyKey(), "yOAaFuAYHH5pHR7QgZGFvw");
