 ...
 */
@Getter
public class GetKeywordBrAndCost {
     ...
     */
    private void runQuery(GoogleAdsClient googleAdsClient, long customerId, double finalBounceRateLevel, double finalCostLevel ) {
    ...
    public void getKeyWords(long accountId, double finalBounceRateLevel, double finalCostLevel){
        GoogleAdsClient googleAdsClient = AdsClientCreator.googleAdsClientCreation();
        try {
            new GetKeywordBrAndCost().runQuery(googleAdsClient, accountId, finalBounceRateLevel, finalCostLevel);
